package com.vice.bloodpressure.decoration;
 ...
 * 描述:
 */
public class UserCenterVideoGridDivider extends RecyclerView.ItemDecoration {
    ...
    public UserCenterVideoGridDivider(Context context) {
        init(context, width, android.R.color.black);
    }

    public UserCenterVideoGridDivider(Context context, int width) {
        init(context, width, android.R.color.black);
    }

    public UserCenterVideoGridDivider(Context context, int width, int color) {
    ...
    public void getItemOffsets(@NonNull Rect outRect, @NonNull View view, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        if (isLastItem(parent, position, childCount) && isLastColum(parent, position, spanCount, childCount)) {
            drawRight = 0;
        }
