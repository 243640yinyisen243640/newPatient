...
public class LineChartUtils {
    ...
    public static void notifyDataSetChanged(LineChart chart, List<Entry> values,
                                            List<String> datelist, String color) {
        ...
        chart.invalidate();
        setChartData(chart, values, LineDataSet.Mode.CUBIC_BEZIER, color);
    }
     ...
     * @param values xy数据集合
     */
    public static void setChartData(LineChart chart, List<Entry> values, LineDataSet.Mode mode, String color) {
