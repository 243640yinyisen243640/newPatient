package com.vice.bloodpressure.utils.luban;
...
enum Checker {
 ...
 /* boolean needCompress(int leastCompressSize, String path) {
  ...
  boolean needCompress(int leastCompressSize, int fileSize) {
    if (leastCompressSize > 0 && fileSize > 0) {
      return fileSize > (leastCompressSize << 10);
    }
    return true;
  }
