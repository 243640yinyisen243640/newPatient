...
//     * @param outputCameraPath Camera save path
    ...
    /**
     * @param isOriginal Whether to open original
     * @return
     */
    public PictureSelectionModel original(boolean isOriginal) {
        selectionConfig.isOriginal = isOriginal;
        return this;
    }
    ...
    /**
     * @param previewClazz 自定义预览
     * @return
     */
    public PictureSelectionModel previewClazz(Class previewClazz) {
        selectionConfig.previewClazz = previewClazz;
        return this;
    }
