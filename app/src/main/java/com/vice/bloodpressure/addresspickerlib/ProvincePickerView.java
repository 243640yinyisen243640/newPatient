...
public class ProvincePickerView extends RelativeLayout implements View.OnClickListener {
    ...
    public ProvincePickerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ProvincePickerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        // UI
        View rootView = inflate(mContext, R.layout.address_province_view, this);
        // 确定
