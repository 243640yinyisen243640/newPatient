 ...
 * 描述:血红蛋白列表
 */
public class ServiceBloodScleroproteinListActivity extends UIBaseListRecycleViewForBgActivity<ServiceInfo> implements View.OnClickListener {
    ...
    private void setPublicBottom() {
        ...
        f2.topMargin = DensityUtils.dip2px(getPageContext(), 170);
