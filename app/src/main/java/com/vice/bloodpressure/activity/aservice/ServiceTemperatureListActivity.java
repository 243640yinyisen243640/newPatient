 ...
 * 描述:体温列表
 */
public class ServiceTemperatureListActivity extends UIBaseListRecycleViewForBgActivity<ServiceInfo> implements View.OnClickListener {
    ...
    protected void getListData(CallBack callBack) {
        ...
        oxygenList.add(new ServiceInfo("2022-05-06 09:54", "36.1", "手动上传"));
        oxygenList.add(new ServiceInfo("2022-05-06 09:54", "36.1", "手动上传"));
        oxygenList.add(new ServiceInfo("2022-05-06 09:54", "36.1", "手动上传"));
        oxygenList.add(new ServiceInfo("2022-05-06 09:54", "36.1", "手动上传"));
        oxygenList.add(new ServiceInfo("2022-05-06 09:54", "36.1", "手动上传"));
