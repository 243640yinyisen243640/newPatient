 ...
 * 描述:
 */
public class EducationFeiTimeActivity extends UIBaseActivity {
    ...
    private void initValues() {
        ...
        //进度
        tvTitle.setText("您患慢性阻塞性肺疾病多长时间了？");
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            answerInfo.setCopdTime(list.get(position).getId());
