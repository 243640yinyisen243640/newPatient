...
//                                String path = isAndroidQ ? getRealPathAndroid_Q(id) : data.getString(data.getColumnIndexOrThrow(PROJECTION[1]));
...
//                                Uri photoUri = Uri.withAppendedPath(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, data.getString(data.getColumnIndexOrThrow(PROJECTION[0])));
//                                Log.e("chen", "photoUri==" + path + "==" + new File(path).isFile());
