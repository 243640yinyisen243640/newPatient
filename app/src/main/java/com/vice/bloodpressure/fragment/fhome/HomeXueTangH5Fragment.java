 ...
 * 描述:
 */
public class HomeXueTangH5Fragment extends UIBaseFragment {
    ...
    public static HomeXueTangH5Fragment getInstance(UserInfo userInfo) {

        HomeXueTangH5Fragment xueTangFragment = new HomeXueTangH5Fragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable("bgModule", userInfo);
    ...
    protected void onCreate() {
        ...
        userInfo = (UserInfo) getArguments().getSerializable("bgModule");
        initView();
        initValues();
    ...
    private void initView() {
        View view = View.inflate(getPageContext(), R.layout.fragment_home_xuetang_h5, null);
        addTv = view.findViewById(R.id.tv_home_fm_xt_add_h5);
        warningTv = view.findViewById(R.id.tv_home_fm_xt_warning_h5);
        x5WebView = view.findViewById(R.id.tv_home_fm_xt_data_h5);
        numTv = view.findViewById(R.id.tv_home_fm_xt_num_h5);
