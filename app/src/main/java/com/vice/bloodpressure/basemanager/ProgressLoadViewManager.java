...
public class ProgressLoadViewManager implements HHSoftLoadViewInterface {
    ...
    //构造方法
    public ProgressLoadViewManager(Context context, View parentView, LoadViewManager.IPageLoad pageLoad) {
        super();
        this.mParentView = parentView;
        this.mContext = context;
        this.mPageLoadInterface = pageLoad;
        //实例化加载的页面
        mLoadingView = View.inflate(context, R.layout.hhsoft_include_load_view_progress, null);
        mLoadingImageView = mLoadingView.findViewById(R.id.huahansoft_iv_loading_second);
        mLoadingTextView = mLoadingView.findViewById(R.id.huahansoft_tv_loading_second);
    }

    @Override
    public void init(LoadViewConfig config) {
        mLoadingView.setBackgroundColor(Color.parseColor(config.loadViewBgColor));
    }
