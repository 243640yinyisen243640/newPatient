...
public class UserDataManager {
     ...
     * @return
     */
    public static Call<String> readOneWarning(String msgId, BiConsumer<Call<String>, BaseResponse> successCallBack, BiConsumer<Call<String>, Throwable> failureCallBack) {
        Map<String, String> map = new HashMap<>();
        map.put("msgId", msgId);
