...
public class EducationQuestionInvestigateAdapter extends BaseAdapter {
    private List<EducationQuestionInvestigateModel> list;
    private Context context;

    public EducationQuestionInvestigateAdapter(List<EducationQuestionInvestigateModel> list, Context context) {
        this.list = list;
