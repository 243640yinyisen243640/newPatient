...
//                        processData(result, callback);
     ...
     * @param callback
     */
    public void processData(String result, @NonNull UpdateCallback callback,UpdateAppBean appBean) {
        try {
            Log.e(TAG, "result=="+HHEncryptUtils.decodeAES_B(result));
//            mUpdateApp = callback.parseJson(result,oldCode);
            mUpdateApp=appBean;
